...
{
	SSPBUF = data;//load value to receiver buffer
	i2c_idle();//check entire 8 bit completely transfered or not
}

void i2c_rx_mode(void)
{
	RCEN = 1;//enable continues receiving
	i2c_idle();
}
...
{
	ACKDT = 1;
	ACKEN = 1;//sending acknowledgement
}
